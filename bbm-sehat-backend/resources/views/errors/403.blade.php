...
<html lang="id">
    <head>
        ...
        <title>Akses Ditolak — BBM Sehat</title>
        <style>
            body {
                margin: 0;
                min-height: 100vh;
    ...
    <body>
        <div class="card">
            <p class="code">403</p>
            <h1>Akses Ditolak</h1>
            <p>{{ $exception->getMessage() ?: 'Anda tidak memiliki akses untuk membuka halaman ini.' }}</p>
            <a href="{{ url('/dashboard/login') }}">Kembali ke halaman masuk</a>
        </div>
    </body>
</html>
